...
public class MainGalaxy {
    ...
    public static void main(String[] args) {
        Galaxy galaxy1 = new Galaxy("MilkWay");
        Planet planet = new Planet("s", Type.Rock, 1, 2000L, Resource.Iron, HasLife.HasLife);

        Galaxy galaxy2 = loadGalaxy(galaxy1);
    ...
    private static Galaxy loadGalaxy(Galaxy galaxy) {
        ...
        try {
            try (Scanner scanner = new Scanner(galaxyFile)) {
                while (scanner.hasNextLine()) {
                    ...
                    Planet planet = new Planet(namePlanet, typeEnum, countMoon, distanceFromSun, resource1, life);
                    galaxy.getListPlanet().add(planet);
                    System.out.println("nameGalaxy : " + nameGalaxy);
